...
const Card = struct {
	...
	pub fn parse(self: *Card, line: []u8) void {
...
const Lottery = struct {
	card_count: usize,
	num_matching: [200]usize,
	copies: [200]usize,

	pub fn play(self: *Lottery) usize {
		var copies: usize = 0;
...
pub fn main() !void {
	...
	var sum: usize = 0;
	var lottery: Lottery = .{.card_count = 0, .num_matching = undefined, .copies = undefined};
